...
const relationshipData = {
  "startDate": "2020-08-01T10:30:00",
  "anniversaryDate": "2025-08-01",
  "timeline": [
    {
      "title": "First Conversation",
      "date": "2020-08-01",
      "description": "The day we first talk with each other online",
      "icon": "💕"
    },
    {
    ...
    {
      "title": "One Year Love Anniversary",
      "date": "2021-08-01",
      "description": "Celebrating our first year of incredible love",
      "icon": "🎁"
    },
    {
      "title": "Two Year Love Anniversary",
      "date": "2022-08-01",
      "description": "Celebrating our second year of incredible love",
      "icon": "🎁"
    },
    {
      "title": "Three Year Love Anniversary",
      "date": "2023-08-01",
      "description": "Celebrating our third year of incredible love",
      "icon": "🎁"
    },
    
    {
      "title": "Weeding",
      "date": "2023-08-15",
      "description": "Celebrating our wedding day",
      "icon": "🎁"
    },
    
    {
      "title": "Four Year Love Anniversary",
      "date": "2024-02-14",
      "description": "Celebrating our first year of incredible love",
      "icon": "🎁"
    },
    {
      "title": "Weeding Anniversary",
      "date": "2024-08-15",
      "description": "Celebrating our first wedding anniversary",
      "icon": "🎁"
    },
  ],
  "memories": [
  ...
  "quizQuestions": [
    {
      ...
      "options": ["Restaurant", "Park", "Tution", "Movies"],
      "correct": 2
    },
    {
...
function updateNextAnniversaryCountdown() {
    ...
    // Use the anniversary date from relationshipData.startDate
    const startDate = new Date(relationshipData.startDate);
    const anniversaryMonth = startDate.getMonth(); // 0-based (January = 0)
    const anniversaryDay = startDate.getDate();

    let nextAnniversary = new Date(now.getFullYear(), anniversaryMonth, anniversaryDay);

    // If today's date has passed this year's anniversary, move to next year
    if (now > nextAnniversary) {
        nextAnniversary = new Date(now.getFullYear() + 1, anniversaryMonth, anniversaryDay);
    }
